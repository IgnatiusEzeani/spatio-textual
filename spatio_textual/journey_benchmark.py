...
def journey_benchmark_row(
    *,
    ...
    """Evaluate one source passage under the frozen SH2026 journey policies.
...
def aggregate_journey_benchmark_rows(rows: Iterable[dict[str, Any]]) -> dict[str, Any]:
    """Pool SH2026 journey metrics over passages without macro-score inflation.
    ...
    return {
        "policy": {
            "journey_matching": "sh2026-journey-match-v1",
            "field_scoring": "sh2026-journey-field-v1",
        },
        "examples": len(items),
