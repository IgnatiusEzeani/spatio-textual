...
GOLD_PATH = Path(__file__).resolve().parents[1] / "tutorials" / "sh2026" / "data" / "gold_reference_v0.1.jsonl"
...
def test_overlap_scoring_exposes_boundary_difference_without_calling_it_total_failure():
    ...
    # A plausible second annotator marks only the quantitative phrase.
